...
/**
 * Tools.MultiKeyHashMap provides to store values with two level hierarchy of keys,
...
public class MultiKeyHashMap<K1,K2,V> {
    ...
    /** Map structure holding another Map structure to implement Tools.MultiKeyHashMap*/
    private Map<K1,Map<K2,V>> mkMap;

    /** Initializes the Tools.MultiKeyHashMap */
    ...
    /**
     * Size of Tools.MultiKeyHashMap
     * @return Tools.MultiKeyHashMap size
     */
    public int size() {
        int size = 0;
        for(Map<K2,V> m : mkMap.values()) {
    ...
    /**
     * Returns all the value objects in the Tools.MultiKeyHashMap
